            ...
            try:
                ...
                if last_min + 1 < new_min:
                    ...
                    for i_test in range(num_test):
                        ...
                        print(dataset.input_names['test'][i_test])
                        ...
                        # save_name = join(test_path, 'test_preds', dataset.input_names['test'][i_test] + '.txt')
                        # preds = preds.astype(np.uint8)
                        # np.savetxt(save_name, preds, delimiter=',', fmt='%d')
